...
//        lvMain.getCheckedItemPositions();
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                myConnection.getOutputStream().write( ("ID=3&theaterID=" + params[0]+"&FilmsID="+params[1]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//            lvMain = (ListView) findViewById(R.id.lvMain);
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.checkbox, parent, false);
            };
